...
<Aside type="tip">
  **You're in the Early Adopter Program.** Right now, you have full access to all Village features at no cost, including unlimited events, all premium features, and team collaboration. See [Account & Plans](/start-here/account-plans) for details.
</Aside>
...
- **Track analytics** to understand event performance and attendance trends
