...
| ------------------------- | ------------------------------------ | --------------------------------------------- | ------------------------------------------- | --------------------------------------- |
| **Price**                 | Free                                 | $7 / month                                    | $25 / month                                 | Invite only                             |
...
## <Badge text="Free" variant="note" size="large" />
...
## <Badge text="Individual" variant="success" size="large"/>
...
## <Badge text="Organization" variant="tip" size="large"/>
...
## <Badge text="Beta" variant="caution" size="large"/>
...
- Everything in the Organization plan — unlimited events, unlimited slots, branding, CSV export, and analytics
