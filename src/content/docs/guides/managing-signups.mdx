...
![Remove signup icon](./src/assets/screenshots/managing-signups/admin-remove.png)
...
<Aside>
  The downloaded file includes all form response columns plus the sign-up
  timestamp for each attendee. Open it in Excel, Google Sheets, or any
