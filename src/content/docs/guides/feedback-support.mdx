...
These features are currently in development or being considered:

- **Granular role permissions** — control what each team member can view and edit (when team collaboration launches, members will inherit your plan's full access)
- **SMS notifications** — text message reminders and confirmations for attendees
- Additional analytics insights and custom reporting options

Have a feature request? Use the in-app [feedback form ](/guides/feedback-support/#in-app-feedback-button) to let us know directly.
