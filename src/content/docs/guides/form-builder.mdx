...
When you select an **Event Type** while creating a new event, the Form Builder is automatically pre-populated with a set of default fields appropriate for that type:
