...
- A **list of attendees by first name** — grouped by slot for slot-based events — if you've enabled **Show attendees publicly** in the event settings
...
## Duplicating an event :badge[Organization]{variant="tip"}
...
Village Live is an optional add-on that lets you broadcast a live session tied to your event. When the add-on is active on your account, two extra options appear in the event actions (**⋯**) menu:

| Menu item | What it does |
| --- | --- |
| **Go Live** | Opens the Village Live management page for this event in a new tab, where you can start and run the live session. |
| **Copy Live Link** | Copies your event's attendee-facing live URL to the clipboard so you can share it directly. |

On the public event sign-up page, attendees see a **Join Live** button. Before the session starts the button shows **Join Waiting Room**; once you go live it changes to **Join Live Event**; after the session ends it shows **Event Ended**.

<Aside>
  Village Live is an add-on and is not included in any standard plan. Contact the Village team if you're interested in adding it to your account.
</Aside>
